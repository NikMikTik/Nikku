...
public class ControllerClass {
	...
	@GetMapping("getForm")
	    ...
	    { result += b.getBlog_id()+b.getBlog()+b.getType() + b.getRating()+b.getBlog_date()+b.getComments()+ "</br>";}
		return result;
	    }
	    ...
	    public String log(@RequestParam String email, @RequestParam String password, HttpServletRequest request)
	    {if((usi.findByEmailAndPassword(email, password)!=null))
